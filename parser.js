...
const cssTestCase = {
    testCaseName: 'CSS solid-border Styles Test',
    testCaseType: 'boundary',
...
const requiredStyles2 = [
    {
        selector: 'dotted-border',
        properties: [
            { key: 'border', value: '3px' },
            { key: 'padding', value: '10px' }
        ]
    }
];
...
const cssTestCase2 = {
    testCaseName: 'CSS dotted border Styles Test',
    testCaseType: 'boundary',
    testLogic: checkCssStyles,
...
const cssTestCase3 = {
    testCaseName: 'CSS dashed-border Styles Test',
    testCaseType: 'boundary',
    testLogic: checkCssStyles,
...
const htmlAttributesTestCase = {
    ...
    extraParams: [[
        { tag: 'div', attribute: 'class', value: 'solid-border' }
    ]]
};

// Define test case for attributes
const htmlAttributesTestCase2 = {
    testCaseName: 'HTML Attribute2 Test',
    testCaseType: 'attribute',
    testLogic: checkHtmlAttributes,
    extraParams: [[
        { tag: 'div', attribute: 'class', value: 'dotted-border' }
    ]]
};

// Define test case for attributes
const htmlAttributesTestCase3 = {
    testCaseName: 'HTML Attribute3 Test',
    testCaseType: 'attribute',
    testLogic: checkHtmlAttributes,
    extraParams: [[
        { tag: 'div', attribute: 'class', value: 'dashed-border' }
    ]]
};
...
function executeAllTestCases() {
    ...
    handleTestCase(filePath, htmlAttributesTestCase2.testCaseName, htmlAttributesTestCase2.testCaseType, htmlAttributesTestCase2.testLogic, htmlAttributesTestCase2.extraParams);
    handleTestCase(filePath, htmlAttributesTestCase3.testCaseName, htmlAttributesTestCase3.testCaseType, htmlAttributesTestCase3.testLogic, htmlAttributesTestCase3.extraParams);
